...
*   **[[Antenna & Tower Safety|Antenna]] Analyzer** - A handheld instrument that generates a low-power signal to measure [[Standing Wave Ratio (SWR)|SWR]], resistance ($R$), and reactance ($X$) of an antenna system across a range of frequencies without using a transmitter.
...
**Scenario:** You measure 8 Watts on a power meter. The setup includes an attenuator (10 [[Decibels & Logarithms|dB]]), a disabled amplifier acting as a load (1 [[Decibels & Logarithms|dB]] loss), and cable/connector losses (2 [[Decibels & Logarithms|dB]]). What is the transmitter output power?
