...
type: index
modified: 2025-12-29
aliases: ["Middenfrequent", "Superhet", "Superheterodyne ontvanger"]
---
...
1.  **RF Amplifier / Preselector**: Selects the desired band, amplifies weak signals, and improves Signal-to-[[AC Signals & Noise|Noise]] ratio. Provides **Far-off [[Receiver Performance|Selectivity]]** (Image rejection).
...
7.  **[[Automatic Gain Control (AGC)|AGC]] ([[Automatic Gain Control (AGC)|Automatic Gain Control]])**: Derives a DC voltage from the signal strength to reduce gain of RF/IF stages, keeping volume constant.
