...
## Characteristics
*   **Path Loss**: Extremely high ($\approx 250 \text{ [[Decibels & Logarithms|dB]]}$ round trip). Only a tiny fraction of the energy reflects off the Moon's surface.
*   **Requirements**:
    *   **High Power**: Usually legal limit (1500W).
    *   **High Gain Antennas**: Arrays of long Yagis or large Dishes.
    *   **Low [[AC Signals & Noise|Noise]] Preamplifiers**: Essential at the antenna to hear the weak echo.
*   **Frequencies**: Typically **50 MHz (6m)** to **10 GHz**, with **144 MHz (2m)** and **1296 MHz (23cm)** being most popular.

## Challenges
*   **Libration [[Fading (QSB)|Fading]]**: Rapid fluttering of the signal caused by the Moon's "wobble" (Libration).
...
## Modes
*   **[[CW Abbreviations & Prosigns|CW]]**: Traditional mode, still used.
