...
2.  **Picket Fencing (Mobile Flutter)**: Rapid fluctuation in signal strength experienced by a **moving** vehicle on [[VHFUHF Bands (6m, 2m, 70cm)|VHF]]/[[VHFUHF Bands (6m, 2m, 70cm)|UHF]].
...
4.  **Flutter Fading**: Rapid, cyclic variation in signal strength.
    *   *Cause:* [[Solar Cycle & Propagation|Propagation]] through **[[Special Propagation Modes|Aurora]]** or highly disturbed ionosphere (Geomagnetic storm).
...
## Mitigation
*   **[[Automatic Gain Control (AGC)|AGC]]**: [[Automatic Gain Control (AGC)|Automatic Gain Control]] in the receiver compensates for volume changes.
