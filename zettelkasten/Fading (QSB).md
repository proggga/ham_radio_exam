...
2.  **Picket Fencing (Mobile Flutter)**: Rapid fluctuation in signal strength experienced by a **moving** vehicle on VHF/UHF.
...
4.  **Flutter Fading**: Rapid, cyclic variation in signal strength.
    *   *Cause:* Propagation through **Aurora** or highly disturbed ionosphere (Geomagnetic storm).
