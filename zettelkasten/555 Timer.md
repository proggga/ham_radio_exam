...
*   **Output**: Can source or sink up to 200mA (enough to drive an [[LED (Light Emitting Diode)|LED]] or small relay directly).
...
*   **Use**: [[Oscillators]], tone generators, [[LED (Light Emitting Diode)|LED]] flashers, Morse code practice oscillators.
