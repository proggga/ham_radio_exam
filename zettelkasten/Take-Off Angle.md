...
tags: ["antennas", "propagation", "definitions"]
created: 2025-01-16
type: permanent-note
aliases: ["Opstraalhoek", "Radiation Angle", "Angle of Radiation", "Elevation Angle"]
---
...
## Importance
The take-off angle determines the distance a [[Sky Wave Propagation|Sky Wave]] signal will travel.
...
*   **High Angle ($> 45^\circ$):** Used for Short Range communications ($0 - 500 \text{ km}$). This is known as **[[Near Vertical Incidence Skywave (NVIS)]]**.
    *   The signal is sent almost straight up and reflected back down nearby, filling the [[Dead Zone (Skip Zone)|Dead Zone]].
