...
*   **Keying:** Usually keys the Driver stage to prevent oscillator instability ("Chirp"). Keying clicks are reduced by a **Key Click [[Filters & Resonance|Filter]]** (LC low pass).
...
*   **Indirect FM (Phase [[Modulation & Digital Signals|Modulation]]):** Modulating the phase of a crystal oscillator.
...
5.  **Linear Amplifier:** Amplifies the signal without distortion ([[Amplifiers|Class A or AB]]). **Class C cannot be used for SSB/[[Analogue Modulation & AM|AM]].**
