...
*   If the [[Standing Wave Ratio (SWR)|SWR]] on the line is high, cable losses will still occur, even if the transmitter sees 1:1.

## Placement
*   **In the Shack**: Protects the radio, but doesn't reduce feedline loss.
*   **Remote (at [[Antenna & Tower Safety|Antenna]])**: The best location. Matches the antenna to the line, ensuring low [[Standing Wave Ratio (SWR)|SWR]] on the entire coax run.
