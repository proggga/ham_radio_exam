...
dutch_title: "Satellietverbindingen"
...
*   **Uplink/Downlink**: The frequencies used.
    *   **Mode U/V**: Uplink on [[VHFUHF Bands (6m, 2m, 70cm)|UHF]] (70cm), Downlink on [[VHFUHF Bands (6m, 2m, 70cm)|VHF]] (2m).
    *   **Mode V/U**: Uplink on [[VHFUHF Bands (6m, 2m, 70cm)|VHF]] (2m), Downlink on [[VHFUHF Bands (6m, 2m, 70cm)|UHF]] (70cm).
*   **Transponder Modes**:
...
1.  **Power**: Use the **minimum power** necessary. Excessive power triggers the satellite's [[Automatic Gain Control (AGC)|AGC]] ([[Automatic Gain Control (AGC)|Automatic Gain Control]]), reducing sensitivity for everyone else ("Alligator" - all mouth, no ears).
...
3.  **[[Doppler Shift]]**: The frequency changes as the satellite moves toward (higher freq) or away (lower freq) from you.
    *   *Correction:* You must adjust your transmit/receive frequency continuously during the pass. [[VHFUHF Bands (6m, 2m, 70cm)|UHF]] requires more correction than VHF.
...
*   **Modes**: [[Frequency Modulation (FM)|FM]] Voice, Packet ([[APRS (Automatic Packet Reporting System)|APRS]]), and [[Image Modes (SSTV & ATV)|SSTV]].
