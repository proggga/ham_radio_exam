...
*   **Mass**: kilogram (kg)
*   **Time**: second (s)
*   **Electric Current**: ampere (A). See [[Voltage, Current, and Ohm's Law]].
...
| **Mega**   | M      | Million    | $10^6$      | MHz ([[Propagation Basics|HF]]/[[VHFUHF Bands (6m, 2m, 70cm)|VHF]] Bands) |
