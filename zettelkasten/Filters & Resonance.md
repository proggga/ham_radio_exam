...
*   **[[Quality Factor (Q)]]** - Q factor.
    *   *Caveat:* Adding a parallel resistor (damping) to an [[Reactive Combinations|LC circuit]] **lowers** the [[Quality Factor (Q)|Q-factor]], **increases** the [[Bandwidth]], and **lowers** the impedance/gain.
...
When two tuned circuits are coupled (e.g., in an IF transformer), the response changes based on the coupling coefficient ($k$) and [[Quality Factor (Q)|Q-factor]] ($Q$).
