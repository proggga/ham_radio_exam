...
3.  Transforms/Regulates using an [[Inductors|Inductor]]/Transformer.
...
## Topologies
Identify these by the arrangement of the [[Inductors|Inductor]] (L), Switch (T), and [[Diodes|Diode]] (D).
*   **Step-Down (Buck)**: Output < Input.
    *   Formula: $U_{out} \approx D \times U_{in}$
    *   *Circuit:* Switch in series, then [[Diodes|Diode]] to ground, [[Inductors|Inductor]] to output.
