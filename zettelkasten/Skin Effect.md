...
1.  **Litz Wire**: Wire made of many thin, individually insulated strands (used at MF/HF). Increases total surface area.
2.  **Silver Plating**: Plating copper wire with silver (highly conductive) reduces resistance at the surface (used at VHF/UHF).
