...
*   **Measurement Types:**
    *   **Current (DC):** Direct measurement. Shunt [[Resistors|Resistors]] used to extend range.
    ...
    *   **Voltage (DC):** Measured as current through a known series resistor.
        ...
        *   **Sensitivity:** Expressed in $k\Omega/V$ (e.g., $20 k\Omega/V$). See [[Voltage, Current, and Ohm's Law|Ohm's Law]].
    ...
    *   **Voltage (AC):** Uses a rectifier ([[Semiconductors|Diode]]). Scale is calibrated for Sine waves (Average -> RMS).
