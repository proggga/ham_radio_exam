...
4.  **[SWR](19_Standing_Wave_Ratio_SWR.md)**: High [Standing Wave Ratio](19_Standing_Wave_Ratio_SWR.md) increases the effective loss.
    *   Current peaks cause higher $I^2R$ heating.
    *   Voltage peaks cause higher dielectric heating.

## Comparison
*   **Open Wire**: Extremely low loss. Ideal for tuned feeders with high [SWR](19_Standing_Wave_Ratio_SWR.md).
*   **Thin Coax (RG-58)**: High loss. Avoid for long runs or [VHF](../07_propagation/07_VHFUHF_Bands_6m,_2m,_70cm.md)/[UHF](../07_propagation/07_VHFUHF_Bands_6m,_2m,_70cm.md).
