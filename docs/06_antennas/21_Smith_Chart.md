...
The **Smith Chart** is a graphical calculator for radio frequency engineering, used to plot impedance, [SWR](20_Standing_Wave_Ratio_SWR.md), and design matching networks.
...
*   **[SWR](20_Standing_Wave_Ratio_SWR.md)**: [Standing Wave Ratio](20_Standing_Wave_Ratio_SWR.md).
