...
*   **[Impedance](../01_electricity/22_Impedance.md) ($Z_0$)**:
...
*   **[Shielding](../01_electricity/21_Shielding.md)**: Keeps the RF field contained inside. Can be run near metal objects or buried.
