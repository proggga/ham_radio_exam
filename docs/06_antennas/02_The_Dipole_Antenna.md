...
*   **Odd Harmonics (3rd, 5th...)**: The center remains a **Current Maximum** (Low [Impedance](../01_electricity/22_Impedance.md)). Can be fed directly.
*   **Even Harmonics (2nd, 4th...)**: The center becomes a **Voltage Maximum** (High [Impedance](../01_electricity/22_Impedance.md)). Hard to feed with low-Z coax.
