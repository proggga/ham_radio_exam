...
*   **[Impedance](../01_electricity/21_Impedance_Impedantie.md)**:
...
*   **Gain**: **Higher gain** ($\approx 3 \text{ [dB](../00_basic_skills.md)}$) than a 1/4 wave vertical because it compresses the radiation pattern closer to the horizon.
...
*   **Use**: Very popular for mobile [VHF](../07_propagation/07_VHFUHF_Bands_6m,_2m,_70cm.md)/[UHF](../07_propagation/07_VHFUHF_Bands_6m,_2m,_70cm.md) work.
