...
Matches the transmitter impedance (usually $50 \Omega$) to the antenna system. See [Matching](../06_antennas/19_Matching_and_SWR.md).
*   **Purpose:** Allows the PA to deliver full power (happy transmitter).
*   **Note:** An [ATU](../06_antennas/22_Antenna_Tuning_Unit_ATU.md) at the transmitter does **NOT** fix the [SWR](../06_antennas/19_Matching_and_SWR.md) on the feedline. It only matches the *input* of the feedline to the TX.
