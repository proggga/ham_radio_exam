...
4.  **[DAC](../01_electricity/40_Digital_Processing_Techniques.md) (Digital-to-Analog Converter)**: Converts the digital amplitude sequence into an analog voltage (stepped sine wave).
