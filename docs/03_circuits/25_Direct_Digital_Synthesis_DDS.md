...
4.  **[DAC](../01_electricity/41_Digital_Processing_Techniques.md) (Digital-to-Analog Converter)**: Converts the digital amplitude sequence into an analog voltage (stepped sine wave).
5.  **Reconstruction [Filter](03_Filters_&_Resonance.md) (Low Pass)**: Removes the clock frequency and aliasing artifacts (steps) to produce a smooth sine wave.
