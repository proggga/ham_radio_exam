...
*   **Transformer Coupling**:
    ...
    *   **Pros**: [Impedance](../01_electricity/22_Impedance.md) matching ($Z_p/Z_s = n^2$), high efficiency (no DC voltage drop in load resistor).
    *   **Cons**: Heavy, expensive, limited bandwidth. Rare in modern audio, common in RF.
*   **Choke Coupling (Smoorspoel)**:
    *   **Components**: [Inductor](../02_components/09_Inductors.md) (Choke) replaces the load resistor.
