...
Building up or collapsing current through an [Inductor](../02_components/09_Inductors.md).
*   **Formula:**
    $$\tau = \frac{L}{R}$$
...
### Process
*   **Current Buildup:**
    *   At $t=0$, [Inductor](../02_components/09_Inductors.md) opposes change (Current 0).
