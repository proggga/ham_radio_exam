...
*   **Quality Factor (Q)** - Q factor.
    *   *Caveat:* Adding a parallel resistor (damping) to an [LC circuit](01_Reactive_Combinations.md) **lowers** the Q-factor, **increases** the Bandwidth, and **lowers** the impedance/gain.
