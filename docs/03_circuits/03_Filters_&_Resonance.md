...
*   **Parallel LC:** Currents cancel out. [Impedance](../01_electricity/21_Impedance_Impedantie.md) is maximal ($Z_{res} = L / (C \cdot R_{loss})$ or $Q \cdot X_L$). Acts as an open circuit.
    *   **Off-[Resonance](05_Resonance.md) Behavior:**
