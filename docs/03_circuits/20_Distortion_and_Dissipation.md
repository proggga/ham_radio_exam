...
*   **[Exam](../12_regulations/05_Licensing_in_the_Netherlands.md) Topic: Dissipation Hyperbola**: A curve plotted on the $I_D - U_{DS}$ graph representing constant power ($P = C$).
...
*   Causes "splatter" in [SSB](../01_electricity/35_Single_Sideband_SSB.md) transmissions.
