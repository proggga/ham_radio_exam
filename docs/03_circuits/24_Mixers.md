...
*   **Single Balanced Mixer (Balanced Modulator)**:
    ...
    *   *Use:* Generating DSB (Double Sideband) for [SSB](../01_electricity/35_Single_Sideband_SSB.md) transmitters.
...
## Applications
*   **[Superheterodyne Receiver](../04_receivers/03_Superheterodyne_Receiver.md)**: Converts RF to a fixed Intermediate Frequency (IF).
*   **Product Detector**: Demodulates [SSB](../01_electricity/35_Single_Sideband_SSB.md)/[CW](../01_electricity/34_CW_Abbreviations_&_Prosigns.md) (mixes IF with BFO).
*   **Modulators**: Creating [AM](../01_electricity/33_Analogue_Modulation_&_AM.md) (unbalanced) or DSB (balanced).
