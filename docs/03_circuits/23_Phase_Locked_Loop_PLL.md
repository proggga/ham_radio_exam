...
4.  **Loop [Filter](03_Filters_&_Resonance.md)**: A Low-Pass [Filter](03_Filters_&_Resonance.md) that smooths the output of the Phase Detector into a DC Control Voltage ($U_{reg}$).
...
*   **[FM](../01_electricity/36_Frequency_Modulation_FM.md) Demodulation**:
    *   The PLL tries to track the incoming [FM](../01_electricity/36_Frequency_Modulation_FM.md) signal (VCO follows input frequency).
