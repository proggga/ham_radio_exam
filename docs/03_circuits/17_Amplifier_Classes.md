...
| :--- | :--- | :--- | :--- | :--- |
| **Class A** | $360^\circ$ | Highest | Low (< 25-50%) | Audio, Pre-amps, [SSB](../01_electricity/35_Single_Sideband_SSB.md) Linear |
| **Class B** | $180^\circ$ | Low | Medium (~50-78%) | Push-Pull Audio/RF |
| **Class AB**| $180^\circ - 360^\circ$| Good | Good | [SSB](../01_electricity/35_Single_Sideband_SSB.md) Linear Amps |
| **Class C** | $< 180^\circ$ | Very Low | High (> 75%) | [FM](../01_electricity/36_Frequency_Modulation_FM.md)/[CW](../01_electricity/34_CW_Abbreviations_&_Prosigns.md) RF PA, Freq Multipliers |
