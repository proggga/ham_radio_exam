...
## Characteristics
*   **Frequency**: Dominant mode for [VHF](08_VHFUHF_Bands_6m,_2m,_70cm.md), [UHF](08_VHFUHF_Bands_6m,_2m,_70cm.md), and Microwave ($> 30 \text{ MHz}$).
...
*   **Formula (HS14)**:
    ...
    *   *[Exam](../12_regulations/05_Licensing_in_the_Netherlands.md) Tip:* Sometimes rounded to $d \approx 4 \sqrt{h}$ (gives slightly high result).
