...
## Mitigation
*   **[AGC](../04_receivers/04_Automatic_Gain_Control_AGC.md)**: [Automatic Gain Control](../04_receivers/04_Automatic_Gain_Control_AGC.md) in the receiver compensates for volume changes.
