...
2.  **Picket Fencing (Mobile Flutter)**: Rapid fluctuation in signal strength experienced by a **moving** vehicle on [VHF](08_VHFUHF_Bands_6m,_2m,_70cm.md)/[UHF](08_VHFUHF_Bands_6m,_2m,_70cm.md).
...
4.  **Flutter Fading**: Rapid, cyclic variation in signal strength.
    *   *Cause:* [Propagation](16_Solar_Cycle_&_Propagation.md) through **[Aurora](11_Special_Propagation_Modes.md)** or highly disturbed ionosphere (Geomagnetic storm).
...
## Mitigation
*   **[AGC](../04_receivers/05_Automatic_Gain_Control_AGC.md)**: [Automatic Gain Control](../04_receivers/05_Automatic_Gain_Control_AGC.md) in the receiver compensates for volume changes.
