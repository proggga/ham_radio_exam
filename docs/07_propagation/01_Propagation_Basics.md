...
Radio waves consist of oscillating Electric ($E$) and Magnetic ($H$) fields. See [Fields](../01_electricity/19_Electric,_Magnetic,_and_Electromagnetic_Fields.md).
*   **Orientation:** $E$ and $H$ are perpendicular to each other and to the direction of travel.
*   **Velocity:** $c \approx 300,000 \text{ km/s}$.
*   **Wavelength:** $\lambda = c / f$. See [AC Signals](../01_electricity/26_AC_Signals_&_Noise.md).
