...
3.  **[Digital Signal Processing (DSP)](../01_electricity/21_Digital_Signal_Processing_DSP.md)**: A processor (FPGA, CPU, or [DSP](../01_electricity/21_Digital_Signal_Processing_DSP.md) chip) performs:
    *   **Filtering**: Extremely sharp digital filters.
    *   **Demodulation**: Converting I/Q data into Audio (AM, FM, SSB) or Digital Data.
    *   **[Noise](../01_electricity/14_AC_Signals_&_Noise.md) Reduction**: Mathematical subtraction of noise.
