...
2.  **Filtering**: The DC is filtered (RC time constant) to remove audio modulation but track fading ([QSB](../07_propagation/17_Fading_QSB.md)).
...
*   Compensates for fading ([QSB](../07_propagation/17_Fading_QSB.md)).
*   Drives the **[S-Meter](08_S-Meter.md)** ([Signal Strength](08_S-Meter.md) Meter).
