...
*   **Key Controls**:
    *   **[SSB](../01_electricity/34_Single_Sideband_SSB.md)/[CW](../01_electricity/33_CW_Abbreviations_&_Prosigns.md)-[FM](../01_electricity/35_Frequency_Modulation_FM.md) Switch**:
        *   *[SSB](../01_electricity/34_Single_Sideband_SSB.md)/[CW](../01_electricity/33_CW_Abbreviations_&_Prosigns.md)*: Adds a delay to the T/R relay to prevent it from dropping out between words (VOX delay). Linear amplification.
        *   *[FM](../01_electricity/35_Frequency_Modulation_FM.md)*: No delay, instant switching. Class C (non-linear) amplification often used for efficiency.
