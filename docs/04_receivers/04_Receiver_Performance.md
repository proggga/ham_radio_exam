...
*   **SINAD:** Signal-to-[Noise](../01_electricity/27_AC_Signals_&_Noise.md) and Distortion ratio. Typical spec: 12dB SINAD.
*   **[Noise](../01_electricity/27_AC_Signals_&_Noise.md) Figure (Ruisgetal, F):** Measure of how much noise the receiver adds.
    $$F = \frac{(S/N)_{in}}{(S/N)_{out}}$$
    *   Ideal receiver: $F = 1$ (0 [dB](../00_basic_skills.md)).
    *   **Independence:** [Noise](../01_electricity/27_AC_Signals_&_Noise.md) Figure is **independent** of bandwidth.
