...
*   **Components:** [Antenna](../06_antennas/01_Antenna_Types.md), Tuning Circuit ($L+C$), [Detector](09_Detectors_Demodulators.md) ([Diode](../02_components/17_Diodes.md)), [Headphones](11_Station_Accessories.md).
...
*   **Structure:** [RF Amplifier](../03_circuits/15_Amplifiers.md) -> [Detector](09_Detectors_Demodulators.md) -> [Audio Amplifier](../03_circuits/15_Amplifiers.md).
*   **Pros:** Simple, more sensitive than crystal receiver.
*   **Cons:**
    *   **[Selectivity](04_Receiver_Performance.md):** Poor at high frequencies ([Q-factor](../03_circuits/06_Quality_Factor_Q.md) is constant, so bandwidth $B = f/Q$ increases with frequency).
...
*   **Pros:** Extremely high gain and selectivity with very few components (e.g., single tube/transistor). Can demodulate [CW](../01_electricity/34_CW_Abbreviations_&_Prosigns.md)/[SSB](../01_electricity/35_Single_Sideband_SSB.md) if allowed to oscillate (autodyne).
...
*   **Pros:** Simple architecture for [SSB](../01_electricity/35_Single_Sideband_SSB.md)/[CW](../01_electricity/34_CW_Abbreviations_&_Prosigns.md). No [Image Frequency](06_Image_Frequency.md) problem (Images are at 0Hz or fold over into audio).
*   **Cons:**
...
*   See [Direct Conversion Receiver](02_Direct_Conversion_Receiver.md) for full details.
...
*   See [Superheterodyne Receiver](03_Superheterodyne_Receiver.md) for full details.
