...
*   **Limiter (Begrenzer)**: Essential before detection to remove Amplitude variations ([Noise](../01_electricity/14_AC_Signals_&_Noise.md)/Static). Usually a saturated amplifier.
