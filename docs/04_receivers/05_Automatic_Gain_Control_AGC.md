...
2.  **Filtering**: The DC is filtered (RC time constant) to remove audio modulation but track fading ([QSB](../07_propagation/18_Fading_QSB.md)).
    *   *Fast AGC:* For [CW](../01_electricity/34_CW_Abbreviations_&_Prosigns.md)/Data (reacts quickly).
    *   *Slow AGC:* For [SSB](../01_electricity/35_Single_Sideband_SSB.md) (holds gain during pauses in speech).
...
*   Compensates for fading ([QSB](../07_propagation/18_Fading_QSB.md)).
*   Drives the **[S-Meter](10_S-Meter.md)** ([Signal Strength](10_S-Meter.md) Meter).
