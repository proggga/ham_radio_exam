...
*   **Usage**: Useful for weak signal work ([SSB](../01_electricity/35_Single_Sideband_SSB.md)/[CW](../01_electricity/34_CW_Abbreviations_&_Prosigns.md)) or overcoming feedline loss.
*   **Key Controls**:
    *   **[SSB](../01_electricity/35_Single_Sideband_SSB.md)/[CW](../01_electricity/34_CW_Abbreviations_&_Prosigns.md)-[FM](../01_electricity/36_Frequency_Modulation_FM.md) Switch**:
        *   *[SSB](../01_electricity/35_Single_Sideband_SSB.md)/[CW](../01_electricity/34_CW_Abbreviations_&_Prosigns.md)*: Adds a delay to the T/R relay to prevent it from dropping out between words (VOX delay). Linear amplification.
        *   *[FM](../01_electricity/36_Frequency_Modulation_FM.md)*: No delay, instant switching. Class C (non-linear) amplification often used for efficiency.
...
*   **Application**: Allows an [HF](../07_propagation/01_Propagation_Basics.md) radio to operate on [VHF](../07_propagation/08_VHFUHF_Bands_6m,_2m,_70cm.md)/UHF/Microwave bands (e.g., 1296 MHz) while retaining the HF radio's advanced features (filters, [DSP](../01_electricity/40_Digital_Signal_Processing_DSP.md)).
...
*   See [Antenna Tuning Unit (ATU)](../06_antennas/26_Antenna_Tuning_Unit_ATU.md) for details.
