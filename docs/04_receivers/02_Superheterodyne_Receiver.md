...
1.  **RF Amplifier / Preselector**: Selects the desired band, amplifies weak signals, and improves Signal-to-[Noise](../01_electricity/14_AC_Signals_&_Noise.md) ratio. Provides **Far-off [Selectivity](05_Receiver_Performance.md)** (Image rejection).
...
## Issues
*   **[Image Frequency](../09_interference/04_Image_Frequency.md) (Spiegelfrequentie)**: An unwanted signal at $f_{image} = f_{RF} \pm 2f_{IF}$ that also mixes to the IF.
