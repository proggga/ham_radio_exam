...
1.  **RF Amplifier / Preselector**: Selects the desired band, amplifies weak signals, and improves Signal-to-[Noise](../01_electricity/26_AC_Signals_&_Noise.md) ratio. Provides **Far-off Selectivity** (Image rejection).
...
7.  **[AGC](03_Automatic_Gain_Control_AGC.md) (Automatic Gain Control)**: Derives a DC voltage from the signal strength to reduce gain of RF/IF stages, keeping volume constant.
...
## Issues
*   **[Image Frequency](04_Image_Frequency.md) (Spiegelfrequentie)**: An unwanted signal at $f_{image} = f_{RF} \pm 2f_{IF}$ that also mixes to the IF.
