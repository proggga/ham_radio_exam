...
## Operation
*   The S-meter is usually driven by the **[AGC](05_Automatic_Gain_Control_AGC.md) voltage** in the IF amplifier.
*   Because [AGC](05_Automatic_Gain_Control_AGC.md) is derived from the signal level, it provides a logarithmic measure suitable for the decibel scale.
