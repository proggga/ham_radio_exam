...
1.  **RF Amplifier / Preselector**: Selects the desired band, amplifies weak signals, and improves Signal-to-[Noise](../01_electricity/27_AC_Signals_&_Noise.md) ratio. Provides **Far-off [Selectivity](04_Receiver_Performance.md)** (Image rejection).
...
7.  **[AGC](05_Automatic_Gain_Control_AGC.md) ([Automatic Gain Control](05_Automatic_Gain_Control_AGC.md))**: Derives a DC voltage from the signal strength to reduce gain of RF/IF stages, keeping volume constant.
8.  **BFO (Beat Frequency Oscillator)**: Needed for [CW](../01_electricity/34_CW_Abbreviations_&_Prosigns.md)/[SSB](../01_electricity/35_Single_Sideband_SSB.md) detection.
...
## Issues
*   **[Image Frequency](06_Image_Frequency.md) (Spiegelfrequentie)**: An unwanted signal at $f_{image} = f_{RF} \pm 2f_{IF}$ that also mixes to the IF.
...
*   **[Block Diagram Identification](07_Block_Diagram_Identification.md)**
