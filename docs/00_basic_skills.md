...
*   **Formula**: $a^2 + b^2 = c^2$
*   **Application**: In AC circuits, Resistance ($R$) and [Reactance](02_components/07_Reactance.md) ($X$) are at right angles. The total [Impedance](01_electricity/22_Impedance.md) ($Z$) is the hypotenuse:
    $Z = \sqrt{R^2 + X^2}$
...
[Energy](01_electricity/09_Power_and_Energy.md) cannot be created or destroyed, only transformed from one form to another.
...
*   **[Inductor](02_components/09_Inductors.md)**: Coiled wire loops (or filled black rectangle in some IEC).
...
*   **[Diode](02_components/17_Diodes.md)**: Arrow pointing to a line (Cathode).
    ...
    *   *[Varicap](02_components/22_Varicap.md)*: Diode symbol combined with a capacitor symbol.
