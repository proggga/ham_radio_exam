...
*   **[CW Abbreviations & Prosigns](01_electricity/34_CW_Abbreviations_&_Prosigns.md)** - Shorthand for Morse code (73, 88, BK).
...
## Listening
You don't need a transmitter to participate. **[WebSDR](04_receivers/08_Software_Defined_Radio_SDR.md)** sites (like the University of Twente's receiver) allow anyone to listen to amateur bands via a web browser. This is an excellent way to become familiar with [Standard QSO Procedure](11_procedures.md).
...
1.  **Calling CQ**: A general call inviting anyone to reply.
    ...
    *   [CW](01_electricity/34_CW_Abbreviations_&_Prosigns.md): "CQ CQ CQ DE PA0ABC K"
...
*   **T (Tone)**: 1 to 9 scale ([CW](01_electricity/34_CW_Abbreviations_&_Prosigns.md) only).
...
*   **[Microphone](04_receivers/11_Station_Accessories.md) Gain (Mic Gain)**: Controls the audio level sent to the transmitter.
    *   *Excessive Gain:* Causes **distortion** and splattering (over-deviation in [FM](01_electricity/36_Frequency_Modulation_FM.md), flat-topping/splatter in [SSB](01_electricity/35_Single_Sideband_SSB.md)).
...
*   **RIT / Clarifier (Receiver Incremental Tuning)**: Changes the *receive* frequency without changing the *transmit* frequency.
    *   *Use:* To tune in a station that is slightly off-frequency (e.g., voice sounds like Donald Duck in [SSB](01_electricity/35_Single_Sideband_SSB.md)) without shifting your own transmit frequency.
*   **RF Gain**: Adjusts the sensitivity of the receiver's RF amplifier stage. Reducing it can help with strong local signals.
*   **[AGC](04_receivers/05_Automatic_Gain_Control_AGC.md) ([Automatic Gain Control](04_receivers/05_Automatic_Gain_Control_AGC.md))**: Automatically adjusts gain to keep audio volume constant despite fading.
    *   *Settings:* Fast ([CW](01_electricity/34_CW_Abbreviations_&_Prosigns.md)), Slow ([SSB](01_electricity/35_Single_Sideband_SSB.md)), Off.
...
*   **Over-Deviation ([FM](01_electricity/36_Frequency_Modulation_FM.md))**: Audio is too loud and clipped.
...
### Mobile Noise
*   **Ignition [Noise](01_electricity/27_AC_Signals_&_Noise.md)**: Popping sound varying with engine RPM.
    *   *Fix:* Use **[Resistor](02_components/01_Resistors.md) Spark Plugs**. Turn on the radio's **[Noise](01_electricity/27_AC_Signals_&_Noise.md) Blanker (NB)**.
...
*   **Conductor**: RF flows on the surface of a conductor (**[Skin Effect](01_electricity/46_Skin_Effect.md)**). Use wide **Copper Strap** or flat braid. Round wire has high impedance (inductance) at RF.
*   **Configuration**:
...
*   **Transponder Modes**:
    *   **[FM](01_electricity/36_Frequency_Modulation_FM.md)**: Single channel, similar to a terrestrial repeater.
    *   **Linear ([SSB](01_electricity/35_Single_Sideband_SSB.md)/[CW](01_electricity/34_CW_Abbreviations_&_Prosigns.md))**: A "passband" transponder that retransmits a range of frequencies (e.g., 20-100 kHz wide). Multiple QSOs can happen simultaneously.

## Operating Procedures
1.  **Power**: Use the **minimum power** necessary. Excessive power triggers the satellite's [AGC](04_receivers/05_Automatic_Gain_Control_AGC.md) ([Automatic Gain Control](04_receivers/05_Automatic_Gain_Control_AGC.md)), reducing sensitivity for everyone else ("Alligator" - all mouth, no ears).
...
*   **Modes**: [FM](01_electricity/36_Frequency_Modulation_FM.md) Voice, Packet ([APRS](11_procedures.md)), and [SSTV](11_procedures.md).
...
*   **Requirements**:
    ...
    *   **Low [Noise](01_electricity/27_AC_Signals_&_Noise.md) Preamplifiers**: Essential at the antenna to hear the weak echo.
...
## Modes
*   **[CW](01_electricity/34_CW_Abbreviations_&_Prosigns.md)**: Traditional mode, still used.
...
*   **[Bandwidth](03_circuits/07_Bandwidth.md)**: Fits within a standard 3 kHz [SSB](01_electricity/35_Single_Sideband_SSB.md) or [FM](01_electricity/36_Frequency_Modulation_FM.md) voice channel.
*   **Transmission Time**: Takes 8 to 120 seconds to send one image (depending on the mode/resolution).
*   **Technology**: Audio tones vary in frequency to represent brightness and color ([FM](01_electricity/36_Frequency_Modulation_FM.md) subcarrier).
*   **Frequencies**: Popular on [20m Band](07_propagation/23_20m_Band.md) (14.230 MHz) and [2m](07_propagation/08_VHFUHF_Bands_6m,_2m,_70cm.md) [FM](01_electricity/36_Frequency_Modulation_FM.md) (145.800 MHz from the **ISS**).
...
*   **Identification**: You must identify your station (voice or [CW](01_electricity/34_CW_Abbreviations_&_Prosigns.md)) periodically, even if the image contains your callsign.
...
*   **[Modulation](01_electricity/32_Modulation_&_Digital_Signals.md)**: AFSK (Audio Frequency [Shift](11_procedures.md) Keying).
...
*   **Military Use**: Used in **SINCGARS** (Single Channel Ground and Airborne Radio System) and **HAVE QUICK** radios to prevent jamming and interception.
    ...
    *   *Requirements:* Stations must be synchronized in **Time** (Time of Day) and **Hopset** (Frequency allocation/[Key](04_receivers/11_Station_Accessories.md)).
...
*   **[Prosigns](01_electricity/34_CW_Abbreviations_&_Prosigns.md)**: Use [CW Abbreviations & Prosigns](01_electricity/34_CW_Abbreviations_&_Prosigns.md) to manage flow (e.g., "BREAK" to interrupt for urgent traffic).
