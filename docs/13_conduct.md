...
*   **Prevent [Interference](09_interference/03_Mixing_Products_Interference.md):** Ensure equipment is technically sound and operated correctly to avoid disrupting other services (military, aviation, emergency) or fellow amateurs. See [Interference](09_interference/01_Types_of_Interference.md).
...
Before pressing the PTT (Push-to-Talk) button, always **listen first** to ensure the frequency is not in use. When transmitting, use the **minimum power necessary** to maintain a contact. This reduces the chance of interference and saves energy.
