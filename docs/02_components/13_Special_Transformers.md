...
## Autotransformer
Uses a single tapped winding. The secondary is part of the primary (or vice versa).
...
*   **4:1 Balun**: [Impedance](../01_electricity/22_Impedance.md) transformer (e.g., $200 \Omega$ antenna to $50 \Omega$ coax).
