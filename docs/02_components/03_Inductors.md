...
An inductor (coil) stores electrical energy in a **magnetic field** (See [Fields](../01_electricity/13_Electric,_Magnetic,_and_Electromagnetic_Fields.md)).
*   **Construction:** A coil of conductive wire, often wound around a core.
    *   **Litz Wire:** Used for MF/[HF](../07_propagation/01_Propagation_Basics.md) coils to reduce **[Skin Effect](../01_electricity/23_Skin_Effect.md)** (Copper losses). Consists of many thin insulated strands.
...
[Key](../04_receivers/07_Station_Accessories.md) factors:
...
*   **[Transformers](04_Transformers.md):** Two magnetically coupled coils.
