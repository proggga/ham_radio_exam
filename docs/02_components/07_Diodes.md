...
*   **[Zener Diode](08_Zener_Diode.md):** Conducts in reverse at a specific "Zener Voltage". Used for Voltage Regulation.
*   **[LED (Light Emitting Diode)](09_LED_Light_Emitting_Diode.md):** Emits light when forward biased.
*   **[Varicap](10_Varicap.md):** Acts as a variable capacitor in reverse bias.
