...
A transformer transfers electrical energy between two or more circuits through electromagnetic induction. It is used to transform Voltage, Current, and [Impedance](../01_electricity/22_Impedance.md).
...
*   **DC**: [Transformers](10_Transformers.md) do **not** work with DC (Direct Current) because a steady current creates a static magnetic field.
...
*   **[Shielding](../01_electricity/21_Shielding.md)**: Placing a conductive shield (Aluminium/Copper) around a coil reduces its Inductance ($L$) and [Quality Factor](../03_circuits/06_Quality_Factor_Q.md) ($Q$) due to induced eddy currents.
