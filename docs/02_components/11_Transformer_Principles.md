...
A transformer transfers electrical energy between two or more circuits through electromagnetic induction. It is used to transform Voltage, Current, and [Impedance](../01_electricity/21_Impedance_Impedantie.md).
