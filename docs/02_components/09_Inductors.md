...
An inductor (coil) stores electrical energy in a **magnetic field** (See [Fields](../01_electricity/20_Electric,_Magnetic,_and_Electromagnetic_Fields.md)).
*   **Construction:** A coil of conductive wire, often wound around a core.
    *   **Litz Wire:** Used for MF/[HF](../07_propagation/01_Propagation_Basics.md) coils to reduce **[Skin Effect](../01_electricity/46_Skin_Effect.md)** (Copper losses). Consists of many thin insulated strands.
    *   **[Shielding](../01_electricity/21_Shielding.md):** MF coils are often shielded with an aluminum can to prevent magnetic field interference with nearby components.
...
[Key](../04_receivers/11_Station_Accessories.md) factors:
...
4.  **Core Material ($\mu_r$):** Relative Permeability.
    ...
    *   *[Shielding](../01_electricity/21_Shielding.md):* A conductive shield (aluminum can) around a coil *reduces* its inductance slightly due to eddy currents in the shield opposing the field.
...
*   **Parallel:** $\frac{1}{L_{tot}} = \frac{1}{L_1} + \frac{1}{L_2}$ (Like [Resistors](01_Resistors.md)).
