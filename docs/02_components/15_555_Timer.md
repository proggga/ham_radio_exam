...
*   **Output**: Can source or sink up to 200mA (enough to drive an [LED](09_LED_Light_Emitting_Diode.md) or small relay directly).
...
*   **Use**: Oscillators, tone generators, [LED](09_LED_Light_Emitting_Diode.md) flashers, Morse code practice oscillators.
