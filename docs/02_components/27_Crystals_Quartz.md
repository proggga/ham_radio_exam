...
*   **[Resonance](../03_circuits/05_Resonance.md):** A crystal behaves like a resonant circuit with two closely spaced resonance frequencies:
    *   **Series [Resonance](../03_circuits/05_Resonance.md) ($f_s$):** Lower frequency. [Impedance](../01_electricity/22_Impedance.md) is very low (Dip).
    *   **Parallel [Resonance](../03_circuits/05_Resonance.md) ($f_p$):** Higher frequency. [Impedance](../01_electricity/22_Impedance.md) is very high (Peak).
