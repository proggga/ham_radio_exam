...
2.  **Common Base (GBS):** Low Input Z, High Output Z. Current gain $\approx 1$. **Good for [HF](../07_propagation/01_Propagation_Basics.md)/[VHF](../07_propagation/15_VHFUHF_Bands_6m,_2m,_70cm.md)** amplification (low feedback capacitance).
...
*   **MOSFET (Metal-Oxide-[Semiconductor](05_Semiconductors.md) FET):**
...
| **[Noise](../01_electricity/14_AC_Signals_&_Noise.md)** | Higher | Lower (generally) |
| **[Sensitivity](../04_receivers/05_Receiver_Performance.md)** | Robust | Sensitive to static (MOSFET) |
