...
[Key](../04_receivers/09_Station_Accessories.md) factors:
...
4.  **Core Material ($\mu_r$):** Relative Permeability.
    ...
    *   *[Shielding](../01_electricity/20_Shielding_Afscherming.md):* A conductive shield (aluminum can) around a coil *reduces* its inductance slightly due to eddy currents in the shield opposing the field.
