...
*   **Grounded Grid (GRS)**:
    ...
    *   *Characteristics:* Non-inverting, Low Input Z. Used in [VHF](../07_propagation/08_VHFUHF_Bands_6m,_2m,_70cm.md)/[UHF](../07_propagation/08_VHFUHF_Bands_6m,_2m,_70cm.md) amplifiers.
