...
*   **Thermal Effects:** RF energy heats body tissue (like a microwave oven).
    ...
    *   **Frequency [Sensitivity](../04_receivers/04_Receiver_Performance.md):**
...
*   **Effect**: A lower duty cycle allows for higher peak power while staying within average limits.
    *   *[FM](../01_electricity/36_Frequency_Modulation_FM.md):* 100% ([Key](../04_receivers/11_Station_Accessories.md) down continuously).
    *   *[CW](../01_electricity/34_CW_Abbreviations_&_Prosigns.md):* $\approx 40\%$.
    *   *[SSB](../01_electricity/35_Single_Sideband_SSB.md):* $\approx 20\%$ (Voice peaks).
