...
*   **Thermal Effects:** RF energy heats body tissue (like a microwave oven).
    ...
    *   **Resonance:** Body absorbs RF best when height $\approx \lambda/2$. See Dipole.
...
*   **EIRP:** Effective Isotropic Radiated Power (Transmitter Power - Cable Loss + Antenna Gain). See Characteristics.
*   **Factors reducing risk:**
    *   **Duty Cycle:** We don't transmit 100% of the time. (CW/SSB < FM). See Transmitters.
