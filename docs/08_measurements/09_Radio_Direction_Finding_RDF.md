...
*   **Military**: Locating enemy units ([Electronic Warfare](../09_interference/09_Electronic_Warfare_Jamming.md) Support).
...
*   **Ferrite Loopstick**: Common in portable [AM](../01_electricity/33_Analogue_Modulation_&_AM.md) radios. Pattern is a Figure-8.
...
*   **Doppler RDF**: Uses an array of antennas switched rapidly to simulate a rotating antenna. The perceived [Doppler Shift](../07_propagation/03_Doppler_Shift.md) of the incoming signal indicates the direction.
