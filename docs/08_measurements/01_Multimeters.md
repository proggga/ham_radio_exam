...
*   **[Sensitivity](../04_receivers/05_Receiver_Performance.md) ($S$):** Expressed in $k\Omega/V$ (e.g., $20 k\Omega/V$). $S = 1 / I_{fsd}$.
...
### AC Measurement
Uses a rectifier ([Diode](../02_components/05_Semiconductors.md)).
...
*   **Features:** Auto-ranging, [Diode](../02_components/07_Diodes.md) test, [Transistor](../02_components/11_Transistors_BJT_&_FET.md) $h_{FE}$, Capacitance.
