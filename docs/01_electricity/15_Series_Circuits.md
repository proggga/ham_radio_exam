...
2.  **Voltage ($U$)**: The source voltage divides across the components.
    ...
    *   The voltage drop across each component is proportional to its resistance ([Ohm's Law](07_Voltage,_Current,_and_Ohm's_Law.md): $U = I \times R$).
...
## Applications
- [Voltage Dividers](17_Voltage_Dividers.md) - Used to tap off a specific voltage.
