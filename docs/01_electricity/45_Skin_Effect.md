...
2.  **Silver Plating**: Plating copper wire with silver (highly conductive) reduces resistance at the surface (used at [VHF](../07_propagation/08_VHFUHF_Bands_6m,_2m,_70cm.md)/[UHF](../07_propagation/08_VHFUHF_Bands_6m,_2m,_70cm.md)).
