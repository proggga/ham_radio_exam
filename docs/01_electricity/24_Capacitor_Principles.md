...
3.  **Higher Dielectric Constant ($\varepsilon_r$)** of the insulator.
    ...
    *   *[Exam](../12_regulations/05_Licensing_in_the_Netherlands.md) Tip:* Inserting a dielectric with $\varepsilon_r = 5$ into an air capacitor increases capacitance by **5x**.
