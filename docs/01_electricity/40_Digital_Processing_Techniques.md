...
## Digital Filters
*   **[Convolution](42_Convolution.md)**: The mathematical operation used to apply a filter to a signal. It involves multiplying overlapping samples of the signal and the filter kernel (impulse response) and summing the results.
