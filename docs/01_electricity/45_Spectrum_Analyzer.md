...
*   **[Modulation](32_Modulation_&_Digital_Signals.md)**: Visualizing sidebands ([AM](33_Analogue_Modulation_&_AM.md)/[FM](36_Frequency_Modulation_FM.md)).

## Comparison with Oscilloscope
*   **[Oscilloscope](44_Oscilloscope.md):** Time Domain (Voltage vs Time). Good for waveform shape.
