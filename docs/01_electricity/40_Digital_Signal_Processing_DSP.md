...
*   **[ADC](41_Digital_Processing_Techniques.md) (Analog-to-Digital Converter)**: Measures the analog voltage at regular intervals.
*   **[Sampling](42_Sampling_Theory.md) Rate ($f_s$)**: How many samples per second.
...
*   **[DAC](41_Digital_Processing_Techniques.md) (Digital-to-Analog Converter)**: Converts the stream of numbers back into a stepped voltage.
...
*   **Quantization [Noise](27_AC_Signals_&_Noise.md)**: The error between the real analog value and the nearest digital step.
    *   More bits = Less noise, higher [Dynamic Range](../04_receivers/04_Receiver_Performance.md). (~6 [dB](../00_basic_skills.md) per bit).

## Digital Filters
*   **Convolution**: The mathematical operation used to apply filters ([Convolution](43_Convolution.md)).
...
*   Converts a signal from **Time Domain** ([Oscilloscope](44_Oscilloscope.md) view) to **Frequency Domain** ([Spectrum Analyzer](45_Spectrum_Analyzer.md) view).
*   Used for filtering, spectral display, and modulation/demodulation.

## DDS (Direct Digital Synthesis)
*   **[Direct Digital Synthesis (DDS)](../03_circuits/25_Direct_Digital_Synthesis_DDS.md)**: Generating waveforms directly from a digital look-up table (Sine table) and a [DAC](41_Digital_Processing_Techniques.md).
