...
*   **Solution**: An **Anti-Aliasing [Filter](../03_circuits/03_Filters_&_Resonance.md)** (Low Pass [Filter](../03_circuits/03_Filters_&_Resonance.md)) must be placed before the [ADC](40_Digital_Processing_Techniques.md) to remove frequencies above $f_s/2$.
