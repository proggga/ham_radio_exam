...
*   **[Modulation](32_Modulation_&_Digital_Signals.md) Index ($m$)**:
    *   Formula: $m = \frac{\Delta f}{f_{mod}}$
    *   *Note:* Different from [AM](33_Analogue_Modulation_&_AM.md) modulation depth. Can be > 1.
...
*   If an FM signal is passed through a **Frequency Multiplier** (e.g., Doubler, Tripler):
    ...
    *   **[Modulation](32_Modulation_&_Digital_Signals.md) Index ($m$)** is multiplied.
    *   **Audio Frequency ($f_{mod}$)** remains **UNCHANGED**.

## Generation
*   **Direct FM**: Modulating a VCO ([Varicap](../02_components/22_Varicap.md)) directly.
*   **Indirect FM**: Using a Phase Modulator after a crystal oscillator.

## Characteristics
*   **[Noise](27_AC_Signals_&_Noise.md) Immunity**: FM receivers limit amplitude variations (static), resulting in quiet backgrounds.
