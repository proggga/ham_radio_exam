...
[Modulation](32_Modulation_&_Digital_Signals.md) is the process of modifying a **Carrier Wave** to convey information.

## AM (Amplitude Modulation)
*   **Method**: Varying the carrier amplitude in sync with the audio signal.
*   **[Modulation](32_Modulation_&_Digital_Signals.md) Depth ($m$)**: $m = \frac{U_{audio}}{U_{carrier}} \times 100\%$.
...
*   **Total Power ($P_{tot}$)**: $P_{tot} = P_c (1 + \frac{m^2}{2})$.
    *   At **100% [Modulation](32_Modulation_&_Digital_Signals.md) ($m=1$)**:
        *   $P_{tot} = 1.5 \times P_c$.
...
*   **Calculation Steps**:
    ...
    2.  Calculate [RMS Voltage](29_RMS_Voltage.md): $U_{eff} = U_{peak} / \sqrt{2}$.
...
*   **Click [Filters](../03_circuits/03_Filters_&_Resonance.md)**: Necessary to round off the keying edges to prevent "[Key](../04_receivers/11_Station_Accessories.md) Clicks" (wideband interference).
*   **Class C**: [CW](34_CW_Abbreviations_&_Prosigns.md) can be amplified by Class C amplifiers (high efficiency) because amplitude is constant (when on).
