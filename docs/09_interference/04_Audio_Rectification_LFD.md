...
*   **[CW](../01_electricity/33_CW_Abbreviations_&_Prosigns.md)**: Thumping or clicking sounds ([Key](../04_receivers/09_Station_Accessories.md) Clicks/Plops) in time with the keying.
*   **[FM](../01_electricity/35_Frequency_Modulation_FM.md)**: Usually silent ([FM](../01_electricity/35_Frequency_Modulation_FM.md) has no amplitude variations). Strong [FM](../01_electricity/35_Frequency_Modulation_FM.md) signals may cause "Blocking" (reduction in volume) or hum.
