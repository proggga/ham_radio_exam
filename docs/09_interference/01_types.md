...
*   **Intermodulation:** Two strong signals ($f_1$ and $f_2$) mix in a non-linear stage (receiver front-end or transmitter PA) to create "phantom" signals.
    *   **Formula:** $f_{IMD} = 2f_1 - f_2$ or $2f_2 - f_1$ (3rd Order). These often fall close to the original frequencies.
...
*   **LFD (Low Frequency Detection):** Also called "Audio Rectification".
    *   **Mechanism:** RF energy is picked up by cables (speaker, microphone, mains) and enters an audio amplifier. A PN junction (transistor/diode) acts as a detector (rectifier).
    *   **Effect:**
