...
*   **Harmonics:** Multiples of the fundamental frequency ($2f, 3f, 4f...$).
    ...
    *   *Cause:* Non-linear amplification ([Class C, AB](../03_circuits/06_Amplifiers.md)) produces harmonics.
*   **Spurious Emissions:** Parasitic oscillations or mixing products generated within the transmitter that are not harmonics.
    *   *Phase [Noise](../01_electricity/14_AC_Signals_&_Noise.md):* "skirts" of noise around the carrier due to [Oscillator](../03_circuits/07_Detectors,_Oscillators_&_Mixers.md) jitter.
