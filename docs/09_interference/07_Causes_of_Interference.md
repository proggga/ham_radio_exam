...
*   **Spurious Emissions:** Parasitic oscillations or mixing products generated within the transmitter that are not harmonics.
    *   *Phase [Noise](../01_electricity/26_AC_Signals_&_Noise.md):* "skirts" of noise around the carrier due to [Oscillator](../03_circuits/21_Detectors,_Oscillators_&_Mixers.md) jitter.
