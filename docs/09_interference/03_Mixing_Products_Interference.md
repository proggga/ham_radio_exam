...
*   **[Mitigation](08_Mitigation.md)**: Use a receiver with a high IP3 (Intercept Point) or add an **Attenuator** (Verzwakker).
...
*   **[Mitigation](08_Mitigation.md)**: Low Pass [Filter](../03_circuits/03_Filters_&_Resonance.md) at the transmitter output.
