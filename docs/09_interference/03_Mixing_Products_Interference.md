...
*   **[Mitigation](08_Mitigation_Ontstoring.md)**: Use a receiver with a high IP3 (Intercept Point) or add an **Attenuator** (Verzwakker).
...
*   **Example**: A 144 MHz (2m) transmitter's 4th harmonic ($4 \times 144 = 576$ MHz) falls into [UHF](../07_propagation/08_VHFUHF_Bands_6m,_2m,_70cm.md) TV Band IV (Channel 34, ~575 MHz).
*   **[Mitigation](08_Mitigation_Ontstoring.md)**: Low Pass [Filter](../03_circuits/03_Filters_&_Resonance.md) at the transmitter output.
