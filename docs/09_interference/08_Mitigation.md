...
*   **[Shielding](../01_electricity/21_Shielding.md) ([Afscherming](../01_electricity/21_Shielding.md))**: Enclose oscillator/RF stages in metal cans ("Inblikken").
...
## 5. Mains Filtering
*   **Mains Filter:** A combination of Series [Inductors](../02_components/09_Inductors.md) and Parallel Capacitors (L-C) built into a module.
