...
| Code | Description |
| :--- | :--- |
| **A** | Amplitude [Modulation](../01_electricity/32_Modulation_&_Digital_Signals.md) (Double Sideband) |
| **C** | Vestigial Sideband |
| **F** | [Frequency Modulation](../01_electricity/36_Frequency_Modulation_FM.md) |
| **G** | Phase [Modulation](../01_electricity/32_Modulation_&_Digital_Signals.md) |
| **H** | [Single Sideband](../01_electricity/35_Single_Sideband_SSB.md), **Full** Carrier (AME) |
| **J** | [Single Sideband](../01_electricity/35_Single_Sideband_SSB.md), **Suppressed** Carrier |
| **N** | Unmodulated carrier |
| **P** | Pulse (unmodulated) |
| **R** | [Single Sideband](../01_electricity/35_Single_Sideband_SSB.md), **Reduced** or Variable Carrier |
...
| :--- | :--- | :--- |
| **A1A** | [AM](../01_electricity/33_Analogue_Modulation_&_AM.md), On/Off keying, Aural | **[CW](../01_electricity/34_CW_Abbreviations_&_Prosigns.md)** (Morse) |
| **A2A** | [AM](../01_electricity/33_Analogue_Modulation_&_AM.md), Tone modulated, Aural | **MCW** (Modulated CW) |
| **A3E** | [AM](../01_electricity/33_Analogue_Modulation_&_AM.md), Analogue, Voice | **[AM](../01_electricity/33_Analogue_Modulation_&_AM.md)** |
| **C3F** | Vestigial Sideband, Video | **Analogue TV** |
| **F1B** | [FM](../01_electricity/36_Frequency_Modulation_FM.md), Direct FSK, Automatic | **RTTY (FSK)** |
| **F2B** | [FM](../01_electricity/36_Frequency_Modulation_FM.md), AFSK Subcarrier, Automatic | **RTTY (AFSK)** |
| **F3E** | [FM](../01_electricity/36_Frequency_Modulation_FM.md), Analogue, Voice | **[FM](../01_electricity/36_Frequency_Modulation_FM.md)** |
| **H3E** | [SSB](../01_electricity/35_Single_Sideband_SSB.md), Full Carrier, Voice | **Compatible AM** |
| **J2B** | [SSB](../01_electricity/35_Single_Sideband_SSB.md), PSK/AFSK, Automatic | **PSK31, RTTY (SSB)** |
| **J3E** | [SSB](../01_electricity/35_Single_Sideband_SSB.md), Suppressed Carrier, Voice | **[SSB](../01_electricity/35_Single_Sideband_SSB.md)** |
...
### Typical Bandwidths
*   **[CW](../01_electricity/34_CW_Abbreviations_&_Prosigns.md)**: `100H` (100 Hz)
*   **[SSB](../01_electricity/35_Single_Sideband_SSB.md)**: `2K70` (2.7 kHz)
*   **[AM](../01_electricity/33_Analogue_Modulation_&_AM.md)**: `6K00` (6 kHz)
*   **[FM](../01_electricity/36_Frequency_Modulation_FM.md) (Narrow)**: `11K0` (11 kHz) - 2.5 kHz deviation
*   **[FM](../01_electricity/36_Frequency_Modulation_FM.md) (Wide)**: `16K0` (16 kHz) - 5 kHz deviation

## Sideband Terminology
*   **Single Sideband Suppressed Carrier (SSB-SC)**: Commonly just called **[SSB](../01_electricity/35_Single_Sideband_SSB.md)**. The carrier and one sideband are suppressed (removed) using filters or phasing. This concentrates all power into the single information-carrying sideband, making it efficient for long-distance communication (less bandwidth, less power wasted on carrier).
